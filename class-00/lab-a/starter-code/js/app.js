...
function displayPics(){
  ...
  // console.log(rando);
  // TODO: In a sentence or two, explain why the previous line of code threw an error when we changed the contiable declaration from `const to `const`.
  // const restricts the variable 'rando' to the code block - it is only scoped to the code block. The console log for 'rando' throws an error because 'rando' is not defined outsdie the code block. To solve this issue, I commented out console.log(rando).
  console.log(viewed);
